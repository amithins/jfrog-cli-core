...
func (m *mockTransferTarget) HasEligibleProperties(metadata *SourceFileMetadata, options TargetDeployOptions) bool {
	eligible, _ := filterEligibleProperties(metadata.Properties, options)
